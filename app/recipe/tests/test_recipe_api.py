...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_tag_on_update(self):
        """Test that a tag is created when updating a recipe"""
        recipe = create_recipe(user=self.user)
        payload = {
            'tags': [{'name': 'Lunch'}],
        }
    ...
    def test_update_recipe_assign_tag(self):
        """Test that a tag is assigned to a recipe"""
    ...
    def test_clear_recipe_tags(self):
        """Test that tags are cleared when updating a recipe"""
        tag_breakfast = Tag.objects.create(user=self.user, name='Breakfast')
        recipe = create_recipe(user=self.user)
        recipe.tags.add(tag_breakfast)
    ...
    def test_create_ingredient_on_update(self):
        """Test that an ingredient is created when updating a recipe"""
        recipe = create_recipe(user=self.user)
        payload = {
    ...
    def test_update_recipe_assign_ingredient(self):
        """Test that an ingredient is assigned to a recipe"""
        ingredient_avocado = Ingredient.objects.create(
            user=self.user, name='Avocado')
        recipe = create_recipe(user=self.user)
    ...
    def test_clear_recipe_ingredients(self):
        """Test that ingredients are cleared when updating a recipe"""
        ingredient_avocado = Ingredient.objects.create(
            user=self.user, name='Avocado')
        recipe = create_recipe(user=self.user)
        recipe.ingredients.add(ingredient_avocado)
